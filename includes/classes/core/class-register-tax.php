...
class Register_Tax {
	...
	public function labels() {
		...
		$labels = [
			...
			'update_item'                => __( 'Update ' . ucwords( $this->singular ), SCP_DOMAIN ),
			'add_new_item'               => __( 'Add New ' . ucwords( $this->singular ), SCP_DOMAIN ),
			'new_item_name'              => __( 'New ' . ucwords( $this->singular ), SCP_DOMAIN ),
			'parent_item'                => __( 'Parent ' . ucwords( $this->singular ), SCP_DOMAIN ),
			'parent_item_colon'          => __( 'Parent ' . ucwords( $this->singular ), SCP_DOMAIN ),
			'popular_items'              => __( 'Popular ' . ucwords( $this->plural ), SCP_DOMAIN ),
			'separate_items_with_commas' => __( 'Separate ' . ucwords( $this->plural ) . ' with commas', SCP_DOMAIN ),
			'add_or_remove_items'        => __( 'Add or Remove ' . ucwords( $this->plural ), SCP_DOMAIN ),
			'choose_from_most_used'      => __( 'Choose from the most used ' . ucwords( $this->plural ), SCP_DOMAIN ),
			'not_found'                  => __( 'No ' . ucwords( $this->plural ) . ' Found', SCP_DOMAIN ),
			'no_terms'                   => __( 'No ' . ucwords( $this->plural ), SCP_DOMAIN ),
