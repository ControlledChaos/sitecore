...
class Register_Type {
	...
	protected function options() {
		...
		$options = [
			...
			'labels'                => $this->labels(),
			'description'           => __( ucfirst( $this->description ), SCP_CONFIG['domain'] ),
			'public'                => $this->public,
	...
	protected function labels() {
		...
		$labels = [
			...
			'add_new'               => __( 'Add New', SCP_CONFIG['domain'] ),
			'add_new_item'          => __( 'Add New ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'edit_item'             => __( 'Edit ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'new_item'              => __( 'New ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'view_item'             => __( 'View ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'view_items'            => __( 'View ' . ucwords( $this->plural ), SCP_CONFIG['domain'] ),
			'search_items'          => __( 'Search ' . ucwords( $this->plural ), SCP_CONFIG['domain'] ),
			'not_found'             => __( 'No ' . ucwords( $this->plural ) . ' Found', SCP_CONFIG['domain'] ),
			'not_found_in_trash'    => __( 'No ' . ucwords( $this->plural ) . ' Found in Trash', SCP_CONFIG['domain'] ),
			'parent_item_colon'     => __( 'Parent ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'featured_image'        => __( 'Featured image for this ' . strtolower( $this->singular ), SCP_CONFIG['domain'] ),
			'set_featured_image'    => __( 'Set featured image for this ' . strtolower( $this->singular ), SCP_CONFIG['domain'] ),
			'remove_featured_image' => __( 'Remove featured image for this ' . strtolower( $this->singular ), SCP_CONFIG['domain'] ),
			'use_featured_image'    => __( 'Use as featured image for this ' . strtolower( $this->singular ), SCP_CONFIG['domain'] ),
			'archives'              => __( ucwords( $this->singular ) . ' archives', SCP_CONFIG['domain'] ),
			'insert_into_item'      => __( 'Insert into ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'uploaded_to_this_item' => __( 'Uploaded to this ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
			'filter_items_list'     => __( 'Filter ' . ucwords( $this->plural ), SCP_CONFIG['domain'] ),
			...
			'attributes'            => __( ucwords( $this->singular ) . ' Attributes', SCP_CONFIG['domain'] ),
			'parent_item_colon'     => __( 'Parent ' . ucwords( $this->singular ), SCP_CONFIG['domain'] ),
		];
