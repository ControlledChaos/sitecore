	...
	function upgrade_0_8_5(){
		...
		foreach( $tasks as $task){
			...
			elseif ( $task === 'dynamic_post_type' ){
				...
				// Old Post Types
				$old_post_types = get_option( 'acfe_dynamic_post_types', [] );
			...
			elseif ( $task === 'dynamic_taxonomy' ){
				...
				// Old Taxonomies
				$old_taxonomies = get_option( 'acfe_dynamic_taxonomies', [] );
			...
			elseif ( $task === 'dynamic_block_type' ){
				...
				// Old Block Types
				$old_block_types = get_option( 'acfe_dynamic_block_types', [] );
			...
			elseif ( $task === 'dynamic_option' ){
				...
				// Old Options
				$old_options = get_option( 'acfe_dynamic_options_pages', [] );
