...
class acfe_field_group_category{
    ...
    function admin_menu(){
        ...
        add_submenu_page('custom-content', __('Field Categories'), __('Field Categories'), acf_get_setting('capability'), 'edit-tags.php?taxonomy=acf-field-group-category', false, 2 );
