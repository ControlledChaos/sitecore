		...
		$this->fields = array(
			...
			'features' => array(
				...
				array(
					...
					'name'          => 'acfe/dev',
					'type'          => 'true_false',
					'description'   => 'Show/hide the advanced post meta in the post Publish metabox. Defaults to false',
					'category'      => 'features',
				),
				array(
					'label'         => 'Edit Options',
					...
					'type'          => 'true_false',
					'description'   => 'Show/hide the Edit Options page. Advanced users only! Defaults to false',
					'category'      => 'features',
				),
				array(
					'label'         => 'Single Meta',
				...
				array(
					'label'         => 'Author Metabox',
					'name'          => 'acfe/modules/author',
					'type'          => 'true_false',
					'description'   => 'Show/hide the Author metabox on post edit screens, if the post type supports author. Defaults to true',
					'category'      => 'features',
				),
				array(
					'label'         => 'Multilingual',
					...
					'type'          => 'true_false',
					'description'   => 'Enable/disable multilingual compatibility module for WPML & Polylang. Defaults to true',
					'category'      => 'features',
				)
			),
