 ...
 *
 * This is a bundled fork of Advanced Custom Fields Pro
 * version 5.9.6, the last version of the plugin released
 * before it was sold to by its originator, Elliot Condon,
 * to the Delicious Brains corporation.
 *
 * The Pro version of Advanced Custom Fields is a premium
 * plugin yet it inherits the GPL license from WordPress.
 * So it is entirely legal to distribute this software for
 * free. That said, this boilerplate plugin respected the
 * wishes of the original developer, and the agreement under
 * which access to this software was purchased, by only
 ...
 * may replace the software in this directory without any
 * modifications to other files in this plugin.
 *
 * Use this bundled software as you would use
