/**
 * Lightbox, carousel, and pan-zoom in one file.
 *
 * @link https://github.com/fancyapps/ui
 */
...
! function(t, n) {
    "object" == typeof exports && "undefined" != typeof module ? n(exports) : "function" == typeof define && define.amd ? define(["exports"], n) : n((t = "undefined" != typeof globalThis ? globalThis : t || self).window = t.window || {})
}(this, (function(t) {
    "use strict";
    ...
    function e(t, n) {
        ...
        for (var o = 0, e = new Array(n); o < n; o++) e[o] = t[o];
        return e
    }
    ...
    var i, a = function() {
        function t(n) {
            ...
            }(this, t), this.panzoom = n, this.$container = null
        }
        var n, e, i;
        return n = t, e = [{
            key: "addButton",
            value: function(t) {
                ...
                return e.setAttribute("title", this.panzoom.localize("{{CONTROLS.".concat(t.toUpperCase(), "}}"))), e.classList.add("panzoom__button"), e.classList.add("panzoom__button--".concat(t)), e.innerHTML = this.panzoom.localize(this.panzoom.option("Controls.tpl.".concat(t), "")), o && e.addEventListener("click", (function(o) {
                    o.stopPropagation(), n.panzoom[t]()
            ...
            value: function() {
                if (!this.$container && this.panzoom.option("zoom")) {
                    ...
                    t.classList.add("panzoom__controls"), this.$container = this.panzoom.$container.appendChild(t);
                    var n, o = r(this.panzoom.option("Controls.buttons", []));
                    try {
                        for (o.s(); !(n = o.n()).done;) {
                            var e = n.value;
                            this.addButton(e, !0)
        ...
        }], e && o(n.prototype, e), i && o(n, i), Object.defineProperty(n, "prototype", {
            writable: !1
        }), t
    }();
    a.defaults = {
    ...
    }, "undefined" != typeof Panzoom && ("object" === n(i = Panzoom.Plugins) && null !== i && i.constructor === Object && "[object Object]" === Object.prototype.toString.call(i)) && (Panzoom.Plugins.Controls = a), t.Controls = a
}));
...
! function(e, t) {
    ...
    var n, s = function() {
        function e(t) {
            ...
            }(this, e), this.carousel = t, this.state = "ready";
            for (var o = 0, n = ["onReady", "onSettle", "onMouseEnter", "onMouseLeave"]; o < n.length; o++) {
                var s = n[o];
                this[s] = this[s].bind(this)
            }
            this.events = {
        ...
        return t = e, (n = [{
            ...
            value: function() {
                var e = this;
                this.clear(), this.timer = setTimeout((function() {
                    "play" === e.state && e.carousel.slideTo(e.carousel.pageIndex + 1)
        ...
        }]) && o(t.prototype, n), s && o(t, s), Object.defineProperty(t, "prototype", {
            writable: !1
        }), e
    }();
    s.defaults = {
        timeout: 3e3,
        hoverPause: !0
    }, "undefined" != typeof Carousel && ("object" === t(n = Carousel.Plugins) && null !== n && n.constructor === Object && "[object Object]" === Object.prototype.toString.call(n)) && (Carousel.Plugins.Autoplay = s), e.Autoplay = s
}));
