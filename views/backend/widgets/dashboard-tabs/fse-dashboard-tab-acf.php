<?php
/**
 * ACF full-site editing dashboard tab
 *
 * @package    Site_Core
 * @subpackage Views
 * @category   Widgets
...
<div id="customize" class="tab-content dashboard-panel-content dashboard-customize-content" style="display: none">
	...
	<p class="description"><?php _e( 'Use the full-site editor to build elements of your website.', 'sitecore' ); ?></p>
	...
	<div class="dashboard-panel-column-container">
		...
		<div class="dashboard-panel-column">
			...
			<div class="dashboard-panel-section-intro dashboard-panel-theme-greeting">
				...
				<div>
					...
					<p class="dashboard-panel-call-to-action"><a class="button button-primary button-hero load-customize hide-if-no-customize" href="<?php echo esc_url( admin_url( 'site-editor.php' ) ); ?>"><?php _e( 'Website Editor' ); ?></a></p>
					<p class="description"><?php _e( 'Build your site with blocks, templates, and design styles.', 'sitecore' ); ?></p>
				</div>
		...
		<div class="dashboard-panel-column dashboard-panel-last">
			...
			<ul>
				<li><a class="dashboard-icon customize-icon-schemes" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_navigation' ) ); ?>"><?php _e( 'Navigation', 'sitecore' ); ?></a></li>
				<li><a class="dashboard-icon customize-icon-headers" href="<?php echo esc_url( admin_url( 'site-editor.php?path=/wp_global_styles' ) ); ?>"><?php _e( 'Styles', 'sitecore' ); ?></a></li>
				<li><a class="dashboard-icon customize-icon-typography" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=page' ) ); ?>"><?php _e( 'Pages', 'sitecore' ); ?></a></li>
				<li><a class="dashboard-icon customize-icon-background" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_template' ) ); ?>"><?php _e( 'Templates', 'sitecore' ); ?></a></li>
				<li><a class="dashboard-icon customize-icon-background" href="<?php echo esc_url( admin_url( 'site-editor.php?postType=wp_block' ) ); ?>"><?php _e( 'Patterns', 'sitecore' ); ?></a></li>
				<?php do_action( 'fse_dashboard_tab_appearance_options' ); ?>
			</ul>
		</div>
